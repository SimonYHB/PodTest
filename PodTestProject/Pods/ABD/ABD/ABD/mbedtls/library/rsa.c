...
int mbedtls_rsa_self_test( int verbose )
{
    ...
    unsigned char rsa_plaintext[PT_LEN_CABD];
    unsigned char rsa_decrypted[PT_LEN_CABD];
    unsigned char rsa_ciphertext[KEY_LEN_CABD];
    ...
    memcpy( rsa_plaintext, RSA_PT, PT_LEN_CABD );

    if( mbedtls_rsa_pkcs1_encrypt( &rsa, myrand, NULL, MBEDTLS_RSA_PUBLIC, PT_LEN_CABD,
    ...
    mbedtls_sha1( rsa_plaintext, PT_LEN_CABD, sha1sum );
